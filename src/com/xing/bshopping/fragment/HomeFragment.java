...
public class HomeFragment extends BaseFragment implements
	...
	private void initView() {
		...
		goodsInfoList.add(new GoodsInfo(2, "珠海长隆企鹅酒店",
				"[湾仔口岸]横琴新区富祥湾","2015.3.3 至 2016.7.4", 2490f, 2300f, 0,
		...
		goodsInfoList.add(new GoodsInfo(3, "珠海长隆马戏酒店",
				"[香洲]横琴新区富祥湾","2016.1.1 至 2016.4.8", 1517f, 1500f, 1,
		...
		goodsInfoList.add(new GoodsInfo(4, "泰国曼谷芭提雅6日游",
				"一晚入住华美达或同级酒店 ， 全程无自费 ，赠送三合一， 广起港止","2016.2.1 至 2016.4.8", 2999f, 2800f, 1,
		...
		goodsInfoList.add(new GoodsInfo(5, "企鹅酒店2人自由行特卖",
		...
		goodsInfoList.add(new GoodsInfo(6, "珠海粤海酒店 Guangdong Hotel",
		...
		goodsInfoList.add(new GoodsInfo(7, "珠海长隆企鹅酒店2人1晚-温馨自驾游",
				"2日多次畅游海洋王国主题乐园＋企鹅宝宝相伴享自助晚餐＋入住长隆企鹅酒店。","2016.3.1 至 2016.5.7", 1890f,1679f, 1,
			...
			public void run() {
				try {
					...
					goodsInfoList.add(0, new GoodsInfo(100, "珠海星城大酒店",
											"[吉大商业街,免税,吉大百货] 吉大区景山路88号(珠海国税局南行约220米)","2015.3.3 至 2016.4.8", 396f, 420f, 0,
					...
					goodsInfoList.add(0, new GoodsInfo(101, "珠海铂濠假日酒店",
							"[前山]香洲区前山镇前山路32号(心海洲对面)","2014.6.27 至 2016.7.28（周末、法定节假日通用）", 1960f, 1860f, 1,
					...
					goodsInfoList.add(0, new GoodsInfo(102, "珠海来魅力假日酒店",
							"[拱北商业区]拱北区围基路32号(拱北口岸出门即是)","2014.6.27 至 2016.7.28", 681f, 596f, 1,
